    ...
    <>
      <div className="bull3_token_head">
        ...
        <div className="token-intro">
          <div className="col1">
            ...
            <p>
              ...
              dolores voluptatum ipsa tempora voluptas, quam deleniti laboriosam
              doloremque possimus beatae!
            </p>
          </div>
          <div className="col2">
        ...
        <div className="multi-chain_coin">
          <h2>
            Buidl token will be also deployed on other DLT protocols (as
            "wrapped buildl"), including on Binance Chain, Near Protocol,
            Ethereum, and others.
          </h2>
          <p>
            buildl will provide bridges between DEIP main network and other
            networks in order to maintain operability and seamless cross-chain
            transactions. DEIP token will always remain liquid both on all
            networks where it has been deployed.
          </p>
        </div>
